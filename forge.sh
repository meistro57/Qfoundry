...
draw_header() {
    clear
    echo -e "${CYAN}==================================================${NC}"
    echo -e "${YELLOW}           QFOUNDRY: THE FORGE MASTER v1.1       ${NC}"
    echo -e "${CYAN}==================================================${NC}"
}
...
echo -e "${BLUE}[2/8] Creating Type-Safe Skeleton (nunomaduro/laravel-starter-kit)...${NC}"
composer create-project nunomaduro/laravel-starter-kit . --prefer-dist --quiet
